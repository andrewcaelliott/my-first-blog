...
def run():
    ...
    loadNumberFacts("./blog/data2/LandUseAgriArable.csv","Land used for arable in ","km^2", encoding="latin1")
    loadNumberFacts("./blog/data2/LandUseAgriPermCrops.csv","Land used for permanent crops in ","km^2", encoding="latin1")
    loadNumberFacts("./blog/data2/LandUseAgriPermPasture.csv","Land used for permanent pasture in ","km^2", encoding="latin1")
