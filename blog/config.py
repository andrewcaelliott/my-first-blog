extent_references = [
    ('Length of trip from the Earth to the Sun','{times:,.2f} times the distance from the Earth to the Sun','1 / {fraction:,.0f} of the distance from the Earth to the Sun'),
    ('Length of trip from the Earth to the Moon','{times:,.2f} times the distance from the Earth to the Moon','1 / {fraction:,.0f} of the distance from the Earth to the Moon'),
    ('Length of trip around the equator','{times:,.2f} times the distance around the equator','1 / {fraction:,.0f} of the distance around the equator'),
    ('Length of trip from London to New York','{times:,.2f} times the distance from London to New York','1 / {fraction:,.0f} of the distance from London to New York'),
    ('Length of trip from London to Edinburgh','{times:,.2f} times the distance from London to Edinburgh','1 / {fraction:,.0f} of the distance from London to Edinburgh'),
    ('Height of Orbit of International Space Station','{times:,.2f} times the height of the orbit of the International Space Station','1 / {fraction:,.0f} of the height of the orbit of the International Space Station'),
    ('Height of Cruising Altitude of Airbus commercial jet','{times:,.2f} times the cruising altitude of a commercial jet','1 / {fraction:,.0f} of the cruising altitude of a commercial jet'),
    ('Height of Mount Everest','{times:,.2f} times the height of Mount Everest','1 / {fraction:,.0f} of the height of Mount Everest'),
    ('Height of Angel Falls (Venuzeula)','{times:,.2f} times the height of Angel Falls (Venuzeula)','1 / {fraction:,.0f} of the height of Angel Falls (Venuzeula)'),
    ('Height of `Burj Khalifa` scyscraper (Dubai)','{times:,.2f} times the height of the `Burj Khalifa` scyscraper (Dubai)','1 / {fraction:,.0f} of the height of the `Burj Khalifa` scyscraper (Dubai)'),
    ('Height of London Eye Ferris Wheel','{times:,.2f} times the height of the London Eye Ferris Wheel','1 / {fraction:,.0f} of the height of the London Eye Ferris Wheel'),
    ('Height of giraffe','{times:,.2f} times the height of a giraffe','1 / {fraction:,.0f} of the height of a giraffe'),
    ('Height of African elephant','{times:,.2f} times the height of an African elephant','1 / {fraction:,.0f} of the height of an African elephant'),
    ('Height of ostrich','{times:,.2f} times the height of an ostrich','1 / {fraction:,.0f} of the height of an ostrich'),
