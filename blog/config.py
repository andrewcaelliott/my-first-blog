extent_references = [
    ...
    ('Height of the `Burj Khalifa` scyscraper (Dubai)','{times:,.2f} times the height of the `Burj Khalifa` scyscraper (Dubai)','1 / {fraction:,.0f} of the height of the `Burj Khalifa` scyscraper (Dubai)'),
